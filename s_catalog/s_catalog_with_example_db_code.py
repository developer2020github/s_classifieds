...
@app.route('/')
def index():
    #query databases to get list of all users
    myUser = User.query.all()
    #an example of getting one user by username.
    #llok for query object documentation on Alchemy website
    oneItem = User.query.filter_by(username="user2").first()
